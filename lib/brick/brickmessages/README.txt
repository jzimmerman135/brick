...
=========
	...
	brick include [brick_stdlib_file_name].h
	----------------------------------------
		Allows you to use brick library file, will install if not already
	downloaded.

	brick drop [brick_stdlib_file_name].h
	-------------------------------------
		Drop dependency on brick library file.

	brick uninstall [brick_stdlib_file_name].h
	------------------------------------------
